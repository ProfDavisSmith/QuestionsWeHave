...
\section{Part \thechapcount.\theseccount: The Design Argument}\stepcounter{seccount}
...
plural=teleological arguments
    ...
    \thoughtex{The Forest Computer}{Suppose that you are walking through the forest, on a hiking trail, and you can across a computer, hooked to a running generator, mouse, keyboard, all on a desk. The computer is on and playing the classic Doom. Would you say that this appeared randomly, or would you say that someone built it?}{ForestComputer.jpg}{A moss-covered computer in the middle of the forest playing the video game Doom.}
...
\section{Part \thechapcount.\theseccount: Problems with the Design Argument}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: The Fine-Tuning Argument}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Problems with The Fine Tuning Argument}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: The First Cause Argument}\stepcounter{seccount}
...
\factoidbox{According to the hypothesis under consideration, it has been established that all the beings in the world have a cause. Now, let the cause itself have a cause, and the cause of the cause have yet another cause, and so on \emph{ad infinitum}. It does not behove you to say that an infinite regress of causes is impossible.... [M]ethods of theoretical inquiry were betrayed by you when you admitted the possibility of temporal phemomena which had no beginning. If it is possible that something infinite should come into existence, why should it not be equally possble for it to have some of its parts working as causes of others... This will be like the Past, which reaches its term in the fleeting `Now', but had no beginning.\autocite[p. 90-91]{alghazali1}}   

al-Ghazali would later present an argument against the notion of a temporally infinite past, accepting the conclusion that there must have been some manner of first cause, but his critique was that one can't just assume that the universe had a beginning, a first cause.
...
\section{Part \thechapcount.\theseccount: Problems with the First Cause Argument}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: The Ontological Argument}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Anselm’s Ontological Argument}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: Problems for the Ontological Argument}\stepcounter{seccount}
...
\subsection{4. If She is all powerful, then (b) She can stop the evil.} 
...
\newglossaryentry{theodicy}
{
name=theodicy,
description={A proposed solution to the Problem of Evil or an explanation as to why God, being all-knowing, all-powerful, and all-good, allows for pain and suffering in the world},
plural=theodicies
}

\section{Part \thechapcount.\theseccount: The Soul-Making Theodicy}\stepcounter{seccount}
There are two different flavors of this theodicy but both claim that the evils in the world serve some greater purpose in that they (according to this account) make people better and therefore more worthy of entering into heaven or some reward in the Hereafter. The first version is sometimes called the Heroes and Saints response and this is the claim that God allows for evil in the world because it is necessary for the even greater good of having saints and heroes. When we learn about these evils we are called to arms against them, we are made heroes. Take for example this story, the events happened, and this only really works as an example of man-made evils:

    \factoidbox{In the First Crusade, there were several armies. Some of them were more official and organized than others. An unofficial, arranged and poorly managed group in the first crusade was lead by a Count Emicho of Flonheim.\footnote{This Count Emicho is often mistaken for a Count Emicho of Leiningen in early records and this mistake has rippled through our understanding of the time.} Emicho's plan for this group was for them to pass from Germany to the Holy Land immediately, which was a major issue because of food scarcity during that time of the year. Rather than following this ill-conceived plan, they eventually thought that the trek to the Holy Land was too far, and noticed that the local Jewish population was a lot closer and unarmed. As a result, they went from town to town, their own towns, pillaging and slaughtering the Jewish people in the region.\footnote{These are often called `the Rhineland massacres'.}  The Church, to their credit, was vehemently opposed to this. They at the very least wanted the fighting outside of Christian dominated territory.  Despite this horrific time, heroes arose to fight this evil. Priests and bishops not only preached against the violence, but even hid the Jewish population in their homes, fortifying the place. When Emicho arived in Speyer, they attacked the Jewish people there, killing 11, but the rest fled and were protected by the local Catholic Bishop. Later that same month, the Catholic Bishop of Worms, hid much of the Jewish population in his palace (though Emicho's forces eventually broke in killing at least 800 jews). Some, if they had the means, raised personal armies to protect them. They used their religious might to protect Jewish places of worship and did their best to save lives.}
...
\section{Part \thechapcount.\theseccount: The Artful Analogy Theodicy}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: The Free Will Defense}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: A Few Initial Replies to the Free Will Defense: How good is Free Will? Do we even have it?}\stepcounter{seccount}
...
\section{Part \thechapcount.\theseccount: The Problem of Natural Evil}\stepcounter{seccount}
...
\subsection{The Demon Theodicy}
When God created the world, She also created legions of angels. Some of these angels, under the leadership of Lucifer, rebelled against God and were cast out of Heaven, becoming demons (also called jinn). According to the Demon Theodicy, these demons also have free will (Libertarian free will).  When Lucifer and the other Fallen rebelled, they did so freely. It's those Fallen angels which cause the `natural' evils in the world.  Just like how man's free will allows for us to do evil and it's still good, these demons' free will allow them to cause suffering and it's still good. So, by this reasoning, the `natural' evils in the world are actually `moral' evils. Added to this, demons are often described has having powers overs some elements or maladies. For example, in his Pseudomonarchia Daemonum, Johann Weyer lists and describes sixty-nine demons along with their ranking.  According to Weyer, the demon duke Agares creates earthquakes,\footnote{Weyer writes ``Agares Dux ... tripudare facit spiritus terrae'' which literally translates as ``the Duke Agares makes the spirits of the earth dance.'' This translation is by Davis Smith. \autocite[p. 650]{Weyer1}} Furfur creates lightning, thunder, and blasts,\footnote{Weyer writes ``concitare fulgura, coruscationes et tonitrua in iis partibus ubi jussum fuerit.'' \autocite[p. 656]{Weyer1} This, in translation, is  ``to summon lighning, flashes, and thunder in the parts where he will be commanded.'' This translation is by Davis Smith.} the demon duke Vepar creates rough seas and the illusion of many ships,\footnote{Weyer writes ``Ut mare jussu magistri turgidum navibusque plenum appareat, efficit'' \autocite[657]{Weyer1} This, again, in translation, is ``He makes it so that the sea commanded by his master is rough and appear to be with many ships.'' As before, this translation is by Davis Smith.} and the demon duke Pucel creates and heats water.\footnote{Weyer's writing on this one, in particular, is very easy to misunderstand, as the phrasing in Latin is quite odd. Weyer writes ``sonitus facit ingentes, et sonare aquas ubi non sunt, easdem, et calefacit.'' \autocite[p. 659]{Weyer1} There are two possible ways to read this passage. The first, which is the more common in other translations, is something like this ``he makes great noises, and the sounds of water where there are none, and he heats the same.'' This reading of the sentence would have it that Pucel can only make the sounds of water and heat waters which are already present and not actually produce waters. This reading, however, ignores the fact that the Weyer uses the infinitive `sonare' (to sound) rather than the word `sonitus', as he does in the begining of the sentence, and this reading also glosses over the word order which Weyer uses. If Weyer had written ``et easdem calefacit'', then the proper translation would be ``and heats the same [waters]'', implying that he cannot create waters himself. But, Weyer writes ``easdem, et calefacit'' which makes `easdem' one of the objects of the verb `facit' (to make), which is reaffirmed by the placement of the comma. So, the proper translation is ``he makes great noises, causes waters to sound where there are none, produces waters, and heats them.'' Here, Weyer is using all the different senses of the Latin verb `facio'. As before, this translation and analysis is by Davis Smith.} Given what we know today about ocean currents and climate change, making more water and making it hotter can be quite devastating to the environment and the people in it.\footnote{Producing water can cause sea levels to rise and the heating of the oceans causes stronger, more violent storms.} While this reply is often cited to St. Augustine, it is Plantinga, the author of the modern version of the Free Will Defense, who actually uses this account\autocite[p.1, in the first footnote]{Allen1} to explain away natural evils in his works expounding the Free Will Defense.\autocite[p. 57-59]{Plantinga2} 

A reply is this theodicy is simply a question: Why does God let these demons interact with the world? God banished them from Heaven so why couldn't She also ban them from Earth or our mortal plane? According to King James VI and I of England and Scottland,\footnote{The same King James who sponsored the publication of the King James Bible.} in his Daemonologie, God does typically ban demons and the fallen angels from interacting with the world, but occasionally does allow them to wreak havoc.  As King James puts it (edited for modern spelling and grammar):

\factoidbox{... [The] Devil knowing well enough, he will not therefore assail us but when we are weak: And besides that, God will not permit him so to dishonor the societies and companies... [W]hen he troubles certain houses, that are dwelt in, it is a sure token either of gross ignorance ot some some gross and flaunderous sins amounst the inhabitants thereof: Which God by that extraordinary rod punishes.\autocite[p. 57]{KingJames1}} 
So, by this addition, while natural evils are the products of demons directly, they are indirectly the product of God enacting some manner of punishment.  

\subsection{The Punishment/Retribution Theodicy}

Within Ethics, there are two pressing questions which have real-world impacts, namely ``why punish?'' and ``how much?'' There are two competing answers to those questions. The first is Conseqentialism, which is broadly explored in Module \ref{ch.modeight} and the other is Retributivism.\footnote{This account, today, is generally a descendant of Kantianism, which is also explored in  Module \ref{ch.modeight}.} Retributivism, as the name implies, says that the purpose of punishment is \emph{retribution}. Some wrong action was done and some suffering therefore must be inflicted on the offender. 

The Retribution or Punishment Theodicy claims that God allows for natural evils to occur because they are punishments for transgressions. The reasoning here is that when a crime is committed, it's unjust for that crime to go unpunished. A just world is better than an unjust one, so a world with the kind of punishment dealt by natural evils is the better of possible options. One does not necessarily need to incorporate The Fall or Demon Theodicies, they are options to make the account, maybe, better. This is the claim that natural disasters are the result of people committing sins, but not necessarily the sins of your ancestors. So, if enough people eat shrimp, God will send down a tidal wave. For a long time, I thought that using this kind of theodicy was exclusively historical, as in no one today actually held it, but this manner of thinking/explanation can be found in very extreme and offensive sects of Christianity, such as the Westboro Baptist Church (don't look them up, they don't deserve the traffic).\footnote{This particular group is so offensive that they intentionally have a homophobic slur in the name of their website.} 
