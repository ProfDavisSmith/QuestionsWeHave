...
plural=teleological arguments
    ...
    \thoughtex{The Forest Computer}{Suppose that you are walking through the forest, on a hiking trail, and you can across a computer, hooked to a running generator, mouse, keyboard, all on a desk. The computer is on and playing the classic Doom. Would you say that this appeared randomly, or would you say that someone built it?}{ForestComputer.jpg}
